...
class User
{
    public static function getUser($id) {
        try {
            ...
            $sql = "SELECT * FROM eshop.eshop_uzivatel WHERE id_uzivatel = :id";
    ...
    public static function update($pid,$pusername,$pheslo,$pjmeno,$pprijmeni,$pemail,$ptelefon) {
        try {
            ...
            $sql = "UPDATE eshop.eshop_uzivatel SET 
    ...
    public static function deleteUser($id) {
        try {
            $conn = Connection::getPdoInstance();
            $sql = "DELETE FROM eshop.eshop_uzivatel WHERE id_uzivatel = :id";
            $stmt = $conn->prepare($sql);
            $stmt->bindParam(':id', $id);
            $stmt->execute();
    ...
    public static function getAll($id) {
        try {
            $conn = Connection::getPdoInstance();
            $stmt = $conn->prepare("SELECT id_uzivatel, username, jmeno, prijmeni, email, telefon FROM eshop.eshop_uzivatel WHERE id_uzivatel <> :id ORDER BY username ASC");
            $stmt->bindParam(':id', $id);
            $stmt->execute();
