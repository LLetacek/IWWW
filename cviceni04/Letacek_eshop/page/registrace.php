...
if ($_POST) {
    ...
    if (empty($validation["submit"]["nok"])) {
        try {
            ...
            $sql = "INSERT INTO eshop.eshop_uzivatel (username, heslo, email, telefon, jmeno, prijmeni, role_id_role) VALUES (:userName, :heslo, :email, :telefon, :jmeno, :prijmeni, 2)";
...
<section class="formWrapper">
        ...
        $dataTable->renderForOneRow("/Letacek_eshop/index.php?page=registrace");
        ?>
