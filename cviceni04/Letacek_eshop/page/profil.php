...
<section class="formWrapper">
        ...
        if(isset($_SESSION["uzivatel"])) {
            ...
            $dataTable->renderForOneRow("/pronajemletadel/index.php?page=profil");
        }
        ?>

        <form action="/Letacek_eshop/index.php?page=logout" method="post" style="text-align: center; padding-top: 15px;" >
