...
<section class="formWrapper">
        ...
        if(isset($_SESSION["uzivatel"])) {
            ...
            $dataTable->render("/pronajemletadel/index.php?page=profil");
        }
        ?>

        <form action="/pronajemletadel/index.php?page=logout" method="post" style="text-align: center; padding-top: 15px;" >
